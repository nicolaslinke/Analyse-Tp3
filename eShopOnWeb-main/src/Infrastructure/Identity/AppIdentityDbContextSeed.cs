...
public class AppIdentityDbContextSeed
{
    public static async Task SeedAsync(AppIdentityDbContext identityDbContext, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
    {
        ...
        var defaultUser2 = new ApplicationUser { UserName = "bob@microsoft.com", Email = "bob@microsoft.com" };
        await userManager.CreateAsync(defaultUser2, AuthorizationConstants.DEFAULT_PASSWORD);
